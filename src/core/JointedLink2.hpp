...
#include "DhParam.hpp"
#include "meshes/JointedLinkMesh2.hpp"
#include <core/PidController.hpp>

// describes a combination of a joint and a link
class JointedLink2 {
public:
	JointedLink2(DhParam params, float joint_rotation, int link_number);
...
private:
	...
	JointedLinkMesh2 mesh_;		// mesh used for graphical representation
