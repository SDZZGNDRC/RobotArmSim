#include "JointedLinkMesh2.hpp"
#include "CylinderMesh.hpp"
#include "BoxMesh.hpp"

using namespace Eigen;

const Vector4f JointedLinkMesh2::JOINT_COLOR = Vector4f(0.05, 0.6, 0.4, 1.0);
const Vector4f JointedLinkMesh2::LINK_COLOR = Vector4f(0.9, 0.0, 0.1, 1.0);


JointedLinkMesh2::JointedLinkMesh2(float z_len, float x_len, int link_number):
	Mesh()
{
	...
	BoxMesh z_link(3*thickness, 0.25*thickness, z_len, LINK_COLOR);
	BoxMesh x_link(3*thickness, 0.25*thickness, x_len, LINK_COLOR);
